...
public class QuizBook {
    ...
    public static int[] images = new int [] {
            ...
            R.drawable.img_0528, R.drawable.pig, R.drawable.slug, R.drawable.elephant, R.drawable.deer, R.drawable.chicken, R.drawable.frog, R.drawable.caterpillar, R.drawable.fish, R.drawable.kangaroo, R.drawable.leopard
    };

    public static boolean[] answers = new boolean[]{
            true, false, false, false, true, true, false, true, true, true, false, false, true, false, true, true, false, true, true
    };
}
